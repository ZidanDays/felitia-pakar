...
?>
  ...
  <div class="content-wrapper">
   ...
   echo "<script>window.alert('pertanyaan selanjutnya')
    window.location='diagnosa16.php'</script>";
             ...
             <form class="forms-sample" action="" method="post" >
                <div class="card-body">
                                             ...
                                             <?php
                                                  include'koneksi.php';
                                                  $no = 1;
                                                  $sql = mysqli_query($koneksi, "SELECT * from gejala WHERE Kd_gejala='G15'");
                ...
                <div class="card-footer">
                  ...
                  <button type="submit" name="RAGU" class="btn btn-primary">TERKADANG </button>
