            ...
            <div class="row">
                <div class="col-lg-12 col-6">
                    ...
                    <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <form id="select" method="POST" action="hasil_diagnosa.php">
                                            <table class="table">
                                                <?php
                                                // Hitung presentase peluang berdasarkan gejala yang terdeteksi
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="78%">
                                                        <?php
                                                        // Tambahkan logika rule sesuai dengan presentase peluang
                                                    ...
                                                    <input type='hidden' class="form-control" type="text" name="kerusakan" id="kerusakan" value="<?php
                                                                                                                                // Tambahkan logika rule untuk value sesuai dengan presentase peluang
                                                                                                                                if ($presentase_siap >= 50) :
                                                                                                                                    echo 'ANAK ANDA DINYATAKAN SIAP UNTUK BERSEKOLAH (P01)';
                                                                                                                                elseif ($presentase_ragu >= 50) :
                                                                                                                                    echo 'ANAK ANDA MASIH RAGU-RAGU UNTUK BERSEKOLAH (P02)';
                        ...
                        <div class="card">
                            <a class="btn btn-sm btn-primary" href="index.php"><span Class="fa fa-arrow-circle-left"></span> Kembali</a>
