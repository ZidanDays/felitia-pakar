                          ...
                          <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <?php
                                  ...
                                  $query_edit = mysqli_query($koneksi, "SELECT * FROM Users WHERE id_user='$id_user'");
                                  ...
                                  ?>
                                        ...
                                        <?php
                                          if (isset($_POST['ubah'])){
                                            ...
                                            $ubah = mysqli_query($koneksi,"UPDATE Users SET nama='$nama', alamat='$alamat', username='$username', password='$password', level='$level' WHERE id_user='$id_user'"); 
                  ...
                  <div id="tambah" class="modal fade" role="dialog">
                              <div class="modal-dialog">
                                ...
                                <?php
                                  ...
                                  $query_edit1 = mysqli_query($koneksi, "SELECT * FROM Users WHERE id_user=(SELECT MAX(id_user) FROM admin)");
                                ...
                                <?php
                                    ...
                                    $level          = "Admin";
                                      ...
                                      $tambah = mysqli_query($koneksi,"INSERT INTO Users (id_user, nama, alamat, username, password, level) VALUES ('$id_user', '$nama', '$alamat', '$username', '$password', '$level')"); 
